...
<figure>
    <img src="img/sun-moon-and-me.png">
    <figcaption>sun, moon, and me</figcaption>
</figure>

Well, it just so happens that the d<sub>sun</sub> = 149.6x10<sup>6</sup> kms, D<sub>sun</sub> = 1.39x10<sup>6</sup> kms so its θ in radians is 0.00929, and d<sub>moon</sub> = 384,400 kms and D<sub>moon</sub> = 3475 kms so its θ in radians is 0.00904. Close enough! How is that for a coincidence? 
