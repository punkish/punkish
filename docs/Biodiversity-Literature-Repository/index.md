...
<div class="watermark">Everything released under <a href="https://creativecommons.org/publicdomain/zero/1.0/" target="_blank">CC0 Public Domain Dedication</a></div>
...
<div class="nofloat">
    <img src="../img/data-via-web.png" style="width: 100%; max-width: 900px;">
</div>
...
<ul class="incremental">
    <li>
        conforms to standards: <span class="dim">TaxPub; DarwinCore;</span> JSON<br>
...
<ul class="incremental">
    <li>
        conforms to standards: <span class="dim">TaxPub; DarwinCore; JSON;</span> LOD
    </li>
</ul>
